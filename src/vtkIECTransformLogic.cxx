...
vtkIECTransformLogic::vtkIECTransformLogic()
{
    ...
    this->IECTransforms.push_back(
        std::make_pair(PatientSupportRotation,
                       FixedReference)); // Rotation component of patient support transform
    this->IECTransforms.push_back(
        std::make_pair(PatientSupport,
                       PatientSupportRotation)); // Scaling component of patient support transform
    this->IECTransforms.push_back(
        std::make_pair(TableTopEccentricRotation,
                       PatientSupportRotation)); // NOTE: Currently not supported by REV
    ...
    this->FixedReferenceToRasTransform->SetObjectName(
        this->GetTransformNameBetween(FixedReference, RAS).c_str());
    this->GantryToFixedReferenceTransform->SetObjectName(
        this->GetTransformNameBetween(Gantry, FixedReference).c_str());
    this->CollimatorToGantryTransform->SetObjectName(
        this->GetTransformNameBetween(Collimator, Gantry).c_str());
    this->WedgeFilterToCollimatorTransform->SetObjectName(
        this->GetTransformNameBetween(WedgeFilter, Collimator).c_str());
    this->LeftImagingPanelToGantryTransform->SetObjectName(
        this->GetTransformNameBetween(LeftImagingPanel, Gantry).c_str());
    this->RightImagingPanelToGantryTransform->SetObjectName(
        this->GetTransformNameBetween(RightImagingPanel, Gantry).c_str());
    this->PatientSupportRotationToFixedReferenceTransform->SetObjectName(
        this->GetTransformNameBetween(PatientSupportRotation, FixedReference).c_str());
    this->PatientSupportToPatientSupportRotationTransform->SetObjectName(
        this->GetTransformNameBetween(PatientSupport, PatientSupportRotation).c_str());
    this->TableTopEccentricRotationToPatientSupportRotationTransform->SetObjectName(
        this->GetTransformNameBetween(TableTopEccentricRotation, PatientSupportRotation).c_str());
    this->TableTopToTableTopEccentricRotationTransform->SetObjectName(
        this->GetTransformNameBetween(TableTop, TableTopEccentricRotation).c_str());
    this->PatientToTableTopTransform->SetObjectName(
        this->GetTransformNameBetween(Patient, TableTop).c_str());
    this->RasToPatientTransform->SetObjectName(this->GetTransformNameBetween(RAS, Patient).c_str());
    this->FlatPanelToGantryTransform->SetObjectName(
        this->GetTransformNameBetween(FlatPanel, Gantry).c_str());
    ...
    this->ElementaryTransforms.push_back(
        this->TableTopEccentricRotationToPatientSupportRotationTransform);
    ...
    this->CoordinateSystemsHierarchy[Gantry] = {Collimator,
                                                LeftImagingPanel,
                                                RightImagingPanel,
                                                FlatPanel};
    this->CoordinateSystemsHierarchy[Collimator] = {WedgeFilter};
    this->CoordinateSystemsHierarchy[PatientSupportRotation] = {PatientSupport,
    ...
    //
    this->GantryToFixedReferenceConcatenatedTransform->Concatenate(
        this->FixedReferenceToRasTransform);
    this->GantryToFixedReferenceConcatenatedTransform->Concatenate(
        this->GantryToFixedReferenceTransform);

    this->CollimatorToGantryConcatenatedTransform->Concatenate(
        this->GantryToFixedReferenceConcatenatedTransform);
    this->CollimatorToGantryConcatenatedTransform->Concatenate(this->CollimatorToGantryTransform);

    this->WedgeFilterToCollimatorConcatenatedTransform->Concatenate(
        this->CollimatorToGantryConcatenatedTransform);
    this->WedgeFilterToCollimatorConcatenatedTransform->Concatenate(
        this->WedgeFilterToCollimatorTransform);

    this->LeftImagingPanelToGantryConcatenatedTransform->Concatenate(
        this->CollimatorToGantryConcatenatedTransform);
    this->LeftImagingPanelToGantryConcatenatedTransform->Concatenate(
        this->LeftImagingPanelToGantryTransform);

    this->RightImagingPanelToGantryConcatenatedTransform->Concatenate(
        this->CollimatorToGantryConcatenatedTransform);
    this->RightImagingPanelToGantryConcatenatedTransform->Concatenate(
        this->RightImagingPanelToGantryTransform);

    this->FlatPanelToGantryConcatenatedTransform->Concatenate(
        this->CollimatorToGantryConcatenatedTransform);
    this->FlatPanelToGantryConcatenatedTransform->Concatenate(this->FlatPanelToGantryTransform);

    this->PatientSupportRotationToFixedReferenceConcatenatedTransform->Concatenate(
        this->FixedReferenceToRasTransform);
    this->PatientSupportRotationToFixedReferenceConcatenatedTransform->Concatenate(
        this->PatientSupportRotationToFixedReferenceTransform);

    this->PatientSupportToPatientSupportRotationConcatenatedTransform->Concatenate(
        this->PatientSupportRotationToFixedReferenceConcatenatedTransform);
    this->PatientSupportToPatientSupportRotationConcatenatedTransform->Concatenate(
        this->PatientSupportToPatientSupportRotationTransform);

    this->TableTopEccentricRotationToPatientSupportRotationConcatenatedTransform->Concatenate(
        this->PatientSupportRotationToFixedReferenceConcatenatedTransform);
    this->TableTopEccentricRotationToPatientSupportRotationConcatenatedTransform->Concatenate(
        this->TableTopEccentricRotationToPatientSupportRotationTransform);

    this->TableTopToTableEccentricRotationConcatenatedTransform->Concatenate(
        this->TableTopEccentricRotationToPatientSupportRotationConcatenatedTransform);
    this->TableTopToTableEccentricRotationConcatenatedTransform->Concatenate(
        this->TableTopToTableTopEccentricRotationTransform);

    this->PatientToTableTopConcatenatedTransform->Concatenate(
    ...
    this->RasToPatientConcatenatedTransform->Concatenate(
...
void vtkIECTransformLogic::PrintSelf(ostream &os, vtkIndent indent)
{
    ...
    os << indent << "FixedReferenceToRasTransform: " << this->FixedReferenceToRasTransform
       << std::endl;
    os << indent << "GantryToFixedReferenceTransform: " << this->GantryToFixedReferenceTransform
       << std::endl;
    os << indent << "CollimatorToGantryTransform: " << this->CollimatorToGantryTransform
       << std::endl;
    os << indent << "WedgeFilterToCollimatorTransform: " << this->WedgeFilterToCollimatorTransform
       << std::endl;
    os << indent << "LeftImagingPanelToGantryTransform: " << this->LeftImagingPanelToGantryTransform
       << std::endl;
    os << indent
       << "RightImagingPanelToGantryTransform: " << this->RightImagingPanelToGantryTransform
       << std::endl;
    os << indent << "FlatPanelToGantryTransform: " << this->FlatPanelToGantryTransform << std::endl;
    os << indent << "PatientSupportRotationToFixedReferenceTransform: "
       << this->PatientSupportRotationToFixedReferenceTransform << std::endl;
    os << indent << "PatientSupportToPatientSupportRotationTransform: "
       << this->PatientSupportToPatientSupportRotationTransform << std::endl;
    os << indent << "TableTopEccentricRotationToPatientSupportRotationTransform: "
       << this->TableTopEccentricRotationToPatientSupportRotationTransform << std::endl;
    os << indent << "TableTopToTableTopEccentricRotationTransform: "
       << this->TableTopToTableTopEccentricRotationTransform << std::endl;
    ...
    os << indent << "GantryToFixedReferenceConcatenatedTransform: "
       << this->GantryToFixedReferenceConcatenatedTransform << std::endl;
    os << indent << "CollimatorToGantryConcatenatedTransform: "
       << this->CollimatorToGantryConcatenatedTransform << std::endl;
    os << indent << "WedgeFilterToCollimatorConcatenatedTransform: "
       << this->WedgeFilterToCollimatorConcatenatedTransform << std::endl;
    os << indent << "LeftImagingPanelToGantryConcatenatedTransform: "
       << this->LeftImagingPanelToGantryConcatenatedTransform << std::endl;
    os << indent << "RightImagingPanelToGantryConcatenatedTransform: "
       << this->RightImagingPanelToGantryConcatenatedTransform << std::endl;
    os << indent
       << "FlatPanelToGantryConcatenatedTransform: " << this->FlatPanelToGantryConcatenatedTransform
       << std::endl;
    os << indent << "PatientSupportRotationToFixedReferenceConcatenatedTransform: "
       << this->PatientSupportRotationToFixedReferenceConcatenatedTransform << std::endl;
    os << indent << "PatientSupportToPatientSupportRotationConcatenatedTransform: "
       << this->PatientSupportToPatientSupportRotationConcatenatedTransform << std::endl;
    os << indent << "TableTopEccentricRotationToPatientSupportRotationConcatenatedTransform: "
       << this->TableTopEccentricRotationToPatientSupportRotationConcatenatedTransform << std::endl;
    os << indent << "TableTopToTableTopEccentricRotationConcatenatedTransform: "
       << this->TableTopToTableEccentricRotationConcatenatedTransform << std::endl;
    os << indent
       << "PatientToTableTopConcatenatedTransform: " << this->PatientToTableTopConcatenatedTransform
       << std::endl;
    os << indent << "RasToPatientConcatenatedTransform: " << this->RasToPatientConcatenatedTransform
       << std::endl;
}
    ...
    CoordinateSystemIdentifier fromFrame, CoordinateSystemIdentifier toFrame)
{
    ...
    vtkErrorMacro("GetElementaryTransformBetween: Elementary transform not found: "
                  << requestedTransformName);
    return nullptr;
}

//-----------------------------------------------------------------------------
std::string vtkIECTransformLogic::GetTransformNameBetween(CoordinateSystemIdentifier fromFrame,
                                                          CoordinateSystemIdentifier toFrame)
{
    return this->CoordinateSystemsMap[fromFrame] + "To" + this->CoordinateSystemsMap[toFrame]
           + "Transform";
}

//-----------------------------------------------------------------------------
bool vtkIECTransformLogic::GetTransformBetween(
    vtkIECTransformLogic::CoordinateSystemIdentifier fromFrame,
    vtkIECTransformLogic::CoordinateSystemIdentifier toFrame,
    ...
    bool transformForBeam /*=false*/)
{
    ...
    if (this->GetPathToRoot(fromFrame, fromFramePath)
        && this->GetPathFromRoot(toFrame, toFramePath)) {
        std::vector<vtkIECTransformLogic::CoordinateSystemIdentifier> toFrameVector(
            toFramePath.size());
        std::vector<vtkIECTransformLogic::CoordinateSystemIdentifier> fromFrameVector(
            fromFramePath.size());
    ...
    vtkErrorMacro("GetTransformBetween: Failed to get transform "
                  << this->GetTransformNameBetween(fromFrame, toFrame));
    return false;
}

//-----------------------------------------------------------------------------
bool vtkIECTransformLogic::GetPathToRoot(vtkIECTransformLogic::CoordinateSystemIdentifier frame,
                                         vtkIECTransformLogic::CoordinateSystemsList &path)
{
...
//-----------------------------------------------------------------------------
bool vtkIECTransformLogic::GetPathFromRoot(vtkIECTransformLogic::CoordinateSystemIdentifier frame,
                                           vtkIECTransformLogic::CoordinateSystemsList &path)
{
